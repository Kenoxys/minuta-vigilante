...
import { Camera, MapPin, Save, ShieldCheck, ClipboardList, TrendingUp, LayoutDashboard, FileText } from 'lucide-react'
import { db } from './firebase'
import { collection, addDoc, query, orderBy, limit, onSnapshot, serverTimestamp } from 'firebase/firestore'
import SignatureCanvas from './SignatureCanvas'
import CameraLive from './CameraLive'
import PDFExport from './PDFExport'
import NovedadesFacturas from './NovedadesFacturas'
import './App.css'

function App() {
  const [view, setView] = useState('minuta')
    ...
    <div className="min-h-screen bg-[#0f172a] text-slate-200 font-sans selection:bg-blue-500/30">
      <div className="max-w-7xl mx-auto p-4 md:p-8 lg:p-12">
        ...
        <nav className="flex justify-center mb-8">
          <div className="bg-slate-800/60 p-1.5 rounded-2xl border border-slate-700/50 backdrop-blur-md flex gap-2">
            <button
              onClick={() => setView('minuta')}
